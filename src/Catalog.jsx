...
export default function Catalog() {
  ...
  .catalog-categories {
    ...
    min-height: 56px;  /* фиксированная высота для предотвращения "скачка" */
  ...
  .catalog-card {
    ...
    min-height: 380px; /* больше высота карточки */
    position: relative;
    justify-content: flex-start;
  }
  .catalog-card img { max-width: 100px; max-height: 100px; margin-bottom: 13px; object-fit: contain; background: transparent; }
  .catalog-card-title { font-weight: 700; font-size: 20px; text-align: center; margin-bottom: 3px; min-height: 48px; display: flex; align-items: center; justify-content: center;}
  ...
  @media (max-width: 600px) {
    ...
    .catalog-products { gap: 11px; grid-template-columns: repeat(1, 1fr); }
    .catalog-card { padding: 11px 3px 10px 3px; min-height: 310px; }
    .catalog-card img { max-width: 54px; max-height: 54px; }
    .catalog-cat-btn { font-size: 15px; padding: 5px 11px; max-width: 160px;}
    .catalog-card-title { font-size: 17px; min-height: 38px; }
  }
  `}
</style>
